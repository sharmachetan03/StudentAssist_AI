...
# --- Terms & Disclaimer (Option 3 - Prominently Above User Profile) ---
with st.sidebar.expander("⚖️ Terms of Use & AI Disclaimer", expanded=True):
    st.caption("""
    **Important Notice for Parents & Students:**
    
    * **Educational Purpose Only:** StudentAssist AI is an educational technology prototype provided "as is" for practice and revision purposes.
    * **No Guarantee of Accuracy:** While our system attempts to align responses with selected curricula and pedagogical guidelines, responses are generated by automated language models and may contain inaccuracies.
    * **Academic Integrity:** Users are encouraged to maintain academic honesty. Answers provided by this platform should be used for concept comprehension rather than submitted directly for formal assessments.
    * **Data Privacy:** Avoid entering sensitive personal identification details (e.g., full passwords, financial information, or government IDs) into the chat prompt.
    """)
