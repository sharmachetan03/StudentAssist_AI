...
# --- Terms & Disclaimer Card (Option 3 - Visible at Top) ---
st.sidebar.markdown("""
<div style="background-color: #0f172a; border: 1.5px solid #38bdf8; border-radius: 8px; padding: 12px; margin-top: 10px; margin-bottom: 15px;">
    <h4 style="color: #38bdf8 !important; margin-top: 0; margin-bottom: 8px; font-size: 0.95rem;">⚖️ Terms of Use & AI Disclaimer</h4>
    <p style="font-size: 0.8rem; color: #cbd5e1 !important; margin-bottom: 8px; font-weight: 600;">Important Notice for Parents & Students:</p>
    <ul style="font-size: 0.76rem; color: #94a3b8 !important; padding-left: 16px; margin: 0; line-height: 1.4;">
        <li style="margin-bottom: 4px;"><b>Educational Purpose Only:</b> Designed for practice and revision purposes.</li>
        <li style="margin-bottom: 4px;"><b>No Guarantee of Accuracy:</b> AI-generated content may contain inaccuracies. Always verify key textbook facts.</li>
        <li style="margin-bottom: 4px;"><b>Academic Integrity:</b> Intended for concept understanding, not copy-pasting homework.</li>
        <li><b>Data Privacy:</b> Avoid entering sensitive personal details into the chat.</li>
    </ul>
</div>
""", unsafe_allow_html=True)
